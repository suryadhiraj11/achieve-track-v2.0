...
export default function AchievementCard({ ach }) {
  ...
  const isOwner =
    currentUser?.id === ach.userId ||
    currentUser?.achievements?.some((a) => a.id === ach.id);
  ...
  const isPublic = ach.visibility === "public";
  ...
  return (
    ...
    >
      <div className="achievement-info">
        ...
        {ach.category && (
          <div style={{ marginTop: 6 }} className="achievement-category">
            {ach.category}
          </div>
        )}
      ...
      <div className="achievement-actions">
        <div className={`visibility ${isPublic ? "public" : "private"}`}>
